...
public abstract class Constants {
     ...
     */
    public static final String GRAPHSTREAM_STYLESHEET = "/de/gnwi/psmilestographstream/resource/PSmilesToGraphStream.css";

    /**
     * A png file to fill the start node
     */
    public static final String GRAPHSTREAM_START_TAG = "/de/gnwi/psmilestographstream/resource/START.png";

    /**
     * A png file to fill the start node when the particle names are reduced
     */
    public static final String GRAPHSTREAM_START_TAG_WITH_BORDERS = "/de/gnwi/psmilestographstream/resource/START_border.png";
    
    /**
     * A png file to fill the end node
     */
    public static final String GRAPHSTREAM_END_TAG = "/de/gnwi/psmilestographstream/resource/END.png";
    
    /**
     * A png file to fill the end node when the particle names are reduced
     */
    public static final String GRAPHSTREAM_END_TAG_WITH_BORDERS = "/de/gnwi/psmilestographstream/resource/END_border.png";
    //</editor-fold>
