...
/**
 * The non language-related constants for the PSmiles Viewer application.
 * 
 * @author Jonas Schaub
 */
public abstract class Constants {
    ...
    /**
     * An enum for the different modes of adding a {@link de.gnwi.psmiles.PSmiles} structure from the 
     * library to the {@link de.gnwi.psmilesviewer.ViewerPanel}'s JTextArea 
    ...
    /**
     * An enum for the four different modes of exporting the {@link de.gnwi.psmiles.PSmiles} graph
    ...
    public enum ImageExportOptions {
        ...
        /**
         * Constant for exporting the {@link de.gnwi.psmiles.PSmiles} graph by adding an 'ui.screenshot'
         * attribute to it.
         */
        GRAPH_ATTRIBUTE (Language.getString("IMAGE_EXPORT_BY_GRAPH_ATTRIBUTE")),
        
        /**
         * Constant for exporting the {@link de.gnwi.psmiles.PSmiles} graph by GraphStream's 
         * {@link org.graphstream.stream.file.FileSinkImages}.
         */
        FILESINKIMAGES (Language.getString("IMAGE_EXPORT_BY_FILESINKIMAGES")),
        
        /**
         * Constant for exporting the {@link de.gnwi.psmiles.PSmiles} graph by using the Swing paint()
         * method.
         */
     ...
     * in the {@link de.gnwi.psmilesviewer.AdditionalSettingsDialog}.
     */
    ...
    /**
     * Initial number of rows for the {@link de.gnwi.psmilesviewer.ViewerPanel}'s text area.
     */
    public static final int TEXTAREA_INITIAL_HEIGTH = 5;
    
    /**
     * Initial number of columns for the {@link de.gnwi.psmilesviewer.ViewerPanel}'s text area.
     */
    public static final int TEXTAREA_INITIAL_WIDTH = 35;
   
    /**
     * Initial selected index for the {@link de.gnwi.psmilesviewer.ViewerPanel}'s JComboBox.
     */
     ...
     * {@link de.gnwi.psmilesviewer.AdditionalSettingsDialog}.
     */
    ...
    /**
     * A factor the {@link de.gnwi.psmiles.PSmiles} graph's node count is multiplied by to determine 
     * the resolution of the written image file
     */
    public static final int NODE_COUNT_TO_RESOLUTION_FACTOR = 20;
    
    /**
     * Minimum node count of the {@link de.gnwi.psmiles.PSmiles} graph from which on to use 
    ...
    /**
     * The color black from Swing as default foreground color of the {@link de.gnwi.psmilesviewer.MainFrame}'s 
     * status label.
     */
    ...
    /**
     * Initial text for the {@link de.gnwi.psmilesviewer.ViewerPanel}'s text area. 
     */
    public static final String TEXTAREA_INITIAL_TEXT = "";
    
    /**
     * Initial text for the {@link de.gnwi.psmilesviewer.ViewerPanel}'s message 
     * label and the {@link de.gnwi.psmilesviewer.MainFrame}'s status label.
     */
     ...
     */
    public static final String APPLICATION_NAME = "PSmilesViewer";
    
    /**
     * The filename of the serialized {@link de.gnwi.psmilesviewer.UserPreferences} object.
     */
    ...
    /**
     * The zoom factor for {@link de.gnwi.psmilesviewer.ViewerPanel} and 
     * {@link de.gnwi.psmilesviewer.AlternativeViewerPanel}.
     */
    ...
    /**
     * The default node weight value for the {@link de.gnwi.psmilesviewer.UserPreferences} 
    ...
    /**
     * The default edge weight value for the {@link de.gnwi.psmilesviewer.UserPreferences}
     * when the user has not specified a value.
     * <p>
     * Note: There does not exist a real default value in GraphStream for this
     * (the default here is when there is no 'layout.weight' attribute stored 
    ...
    /**
     * Preferred size for the {@link de.gnwi.psmilesviewer.ViewerPanel}'s GraphStream 
     ...
     * {@link de.gnwi.psmilesviewer.StructureLibraryPanel}'s JSplitPane.
     */
    public static final Dimension LIBRARY_PANEL_SCROLLPANES_MIN_SIZE = new Dimension(400, 100);
    
    /**
     * The minimum size of the {@link de.gnwi.psmilesviewer.ViewerPanel}'s 
    ...
    /**
     * The default value for {@link de.gnwi.psmilesviewer.UserPreferences}' field
     * specifying whether the particle names should be written out in full on the 
     * {@link de.gnwi.psmiles.PSmiles} graph's nodes.
     */
