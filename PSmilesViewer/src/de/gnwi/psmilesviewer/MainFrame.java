...
/**
 * The PSmiles Viewer application's main frame consisting of a JTabbedPane 
 * (that holds the {@link de.gnwi.psmilesviewer.ViewerPanel}, the 
 * {@link de.gnwi.psmilesviewer.AlternativeViewerPanel}, the 
 * {@link de.gnwi.psmilesviewer.StructureLibraryPanel}) 
 * and a JPanel that serves as a status bar. A JMenuBar 
 * (see {@link de.gnwi.psmilesviewer.MenuBar}) must be 
...
public class MainFrame extends JFrame{
     ...
     *
     * @param aViewerPanel a {@link de.gnwi.psmilesviewer.ViewerPanel} instance 
     * for the first tab
     * @param anAlternativeViewerPanel an {@link de.gnwi.psmilesviewer.AlternativeViewerPanel} 
     * instance for the second tab
     * @param aStructureLibraryPanel a {@link de.gnwi.psmilesviewer.StructureLibraryPanel}
    ...
    /**
     * Returns the frame's JTabbedPane that holds the three tabs ({@link de.gnwi.psmilesviewer.ViewerPanel}, 
     * {@link de.gnwi.psmilesviewer.AlternativeViewerPanel} and {@link de.gnwi.psmilesviewer.StructureLibraryPanel})
     * 
