 ...
 * {@link de.gnwi.psmiles.PSmiles} graph by GraphStream's 
...
public class ImageExportFileSinkImagesWorker extends SwingWorker {
     ...
     * written image file.
     * @param aMainFrame the {@link de.gnwi.psmilesviewer.MainFrame} 
     ...
     * {@link de.gnwi.psmilesviewer.UserPreferences}' 'valid' color is 'null'
     */
    ...
    /**
     * Exports the given {@link de.gnwi.psmiles.PSmiles} graph by using GraphStream's 
     * {@link org.graphstream.stream.file.FileSinkImages} as an image file.
     * <p>
     ...
     * (node count times 
     * {@link de.gnwi.psmilesviewer.Constants#NODE_COUNT_TO_RESOLUTION_FACTOR}) 
     * but has a minimum as set in 
     * {@link de.gnwi.psmilesviewer.Constants#IMAGE_FILE_MIN_WIDTH_AND_HIGHT}.
     * At higher node counts (margins are set in the different constants in the 
     * {@link de.gnwi.psmilesviewer.Constants} class)
     ...
     * the {@link de.gnwi.psmilesviewer.MainFrame} displays a message in its status bar.
     * 
     * 
     * @return null
     */
