 ...
 * be set in the {@link de.gnwi.psmilesviewer.MenuBar}, such as 
...
public class AdditionalSettingsDialog extends JDialog {
    ...
    /**
     * Returns the dialog's JButton that is supposed to restore the PSmiles graph's node weight to its default value.
     * 
    ...
    /**
     * Returns the dialog's JButton that is supposed to restore the PSmiles graph's edge weight to its default value.
     * 
    ...
    /**
     * Returns the dialog's JButton that is supposed to restore the PSmiles graph's node size to its default value.
     * 
    ...
    /**
     * Returns the dialog's JSlider that is supposed to adjust the PSmiles graph's node size. 
     * 
    ...
    /**
     * Returns the dialog's JTextField where the user can enter a node weight for the PSmiles graph.
     * 
    ...
    /**
     * Returns the dialog's JTextField where the user can enter an edge weight for the PSmiles graph.
     * 
