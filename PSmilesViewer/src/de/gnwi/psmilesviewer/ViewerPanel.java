 ...
 * PSMILES line notation be invalid, a GraphStream 
 ...
 * PSMILES structure for individual
...
public class ViewerPanel extends JPanel {
    ...
    /**
     * A JLabel for displaying the PSmiles' error message or 'valid' if there is
    ...
    /**
     * A JLabel to request the user to choose which part of the PSMILES structure 
     * (if it has multiple parts) should be displayed.
     */
    private final JLabel choosePartLabel;
    
    /**
     * A JComboBox for the user to choose which part of the PSmiles is to be shown.
     */
    private final JComboBox<String> comboBox;
    
    /**
     * A GraphStream ViewPanel to display the PSmiles graph.
     */
     ...
     * {@link de.gnwi.psmiles.PSmiles} graph
    ...
    /**
     * Returns the panel's JButton that is supposed to reset the PSmiles graph displaying GraphStream
     ...
     * a PSMILES line notation for the represented structure to be displayed.
     * 
     * @return the JTextArea where a PSMILES line notation should be entered by the user
     */
     ...
     * which part of the PSmiles structure to display.
     * 
    ...
    /**
     * Returns the panel's GraphStream {@link org.graphstream.ui.swingViewer.ViewPanel} that displays the PSmiles graph.
     * 
     * @return the GraphStream ViewPanel displaying the PSmiles graph
     */
    ...
    /**
     * Returns the panel's JLabel that is supposed to display "valid" if the entered PSMILES line notation is 
