...
/**
 * A JPanel to present the user some exemplary PSMILES 
 * structures (loaded from a 'Structure.properties' file)
 * that can be displayed in the {@link de.gnwi.psmilesviewer.ViewerPanel}.
 * It consists of a JList where the structure names are displayed, a JTextArea
 * where the selected PSMILES line notation is displayed, 
 * a JComboBox to choose in which way the selected structure should be added to the 
 * {@link de.gnwi.psmilesviewer.ViewerPanel} and a JButton to add the structure.
 * 
 * @author Jonas Schaub
 */
public class StructureLibraryPanel extends JPanel {
    ...
    /**
     * A JList for displaying the name keys of the PSMILES structures.
     */
    ...
    /**
     * A JTextArea to display the PSMILES structure linked to the selected
     ...
     * selected PSMILES structure to the text area of the 
     * {@link de.gnwi.psmilesviewer.ViewerPanel} using the 
     * selected addition mode.
     * 
     * @return the JButton that should transmit the 
     * selected PSMILES structure to the ViewerPanel
     */
     ...
     * PSMILES structures' names.
     * 
     * @return the JList that displays the PSMILES structures' names
     */
     ...
     * modes described in {@link de.gnwi.psmilesviewer.Constants.AddStructureOptions}.
     * 
    ...
    /**
     * Returns the panel's JTextArea that is supposed to display the PSMILES line notation 
     * linked to the selected structure name in the list above.
     * 
     * @return the JTextArea that should display the PSMILES line notation upon selection of a structure name 
     */
