 ...
 * to the {@link de.gnwi.psmiles.PSmiles} graph to get some necessary informations for the application.
 * 
 * @author Jonas Schaub
 */
public class UserPreferences implements Serializable {
    ...
    /**
     * The String representation of the css file added to the PSmiles graph as stylesheet.
     */
     ...
     * Constructor:
     * It invokes 
     * {@link de.gnwi.psmilesviewer.UserPreferences#loadDefaultsFromCSS()} 
     ...
     * PSmiles graph as stylesheet in the PSmilesToGraphStreamModel; If its 'null'
     ...
     * {@link de.gnwi.psmilesviewer.Constants#DEFAULT_CSS_STYLESHEET} will 
     ...
     * or lower than {@link de.gnwi.psmilesviewer.Constants#NODE_SIZE_SLIDER_MIN}.
     */
     ...
     * {@link de.gnwi.psmilesviewer.Constants#DEFAULT_NODE_WEIGHT})
     */
     ...
     * {@link de.gnwi.psmilesviewer.Constants#DEFAULT_EDGE_WEIGHT})
     */
    ...
    /**
     * Gives the PSmiles graph's node size as set in its stylesheet.
     * 
    ...
    /**
     * Gives the PSmiles graph's node shape as set in its stylesheet.
     * 
     ...
     * names should be written out in full on the {@link de.gnwi.psmiles.PSmiles} graph's nodes
     */
     ...
     * {@link de.gnwi.psmilesviewer.Constants#DEFAULT_ERROR_COLOR}.
     */
     ...
     * {@link de.gnwi.psmilesviewer.Constants#DEFAULT_VALID_COLOR}.
     */
     ...
     * names should be written out in full on the {@link de.gnwi.psmiles.PSmiles} graph's nodes to 
     * {@link de.gnwi.psmilesviewer.Constants#IS_FULL_PARTICLE_NAME_DISPLAY_DEFAULT}.
     */
     ...
     * {@link de.gnwi.psmilesviewer.Constants#DEFAULT_USER_IMAGE_FILE_DIR}.
     */
     ...
     * defined in {@link de.gnwi.psmilesviewer.Constants.Shape}
     * @throws IllegalArgumentException if aShapeKey can not be found in 
     * {@link de.gnwi.psmilesviewer.Constants.Shape} or is 'null'
     */
