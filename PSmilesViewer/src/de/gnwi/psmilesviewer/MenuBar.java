...
/**
 * A JMenuBar for the application's {@link de.gnwi.psmilesviewer.MainFrame}. 
 * It contains menus for setting 
 * graph properties (like node shape, node color, behavior for long particle
 * names and opening the {@link de.gnwi.psmilesviewer.AdditionalSettingsDialog}), 
...
public class MenuBar extends JMenuBar {
    ...
    /**
     * A JMenuItem to export the PSmiles graph as an image file via graph attribute.
     */
    private final JMenuItem imageExportByGraphAttributeMenuItem;
    
    /**
     * A JMenuItem to export the PSmiles graph as an image file via GraphStream's FileSinkImages.
     */
    private final JMenuItem imageExportByFileSinkImagesMenuItem;
    
    /**
     * A JMenuItem to export the PSmiles graph as an image file using Swing.
     */
    ...
    /**
     * Returns the menu bar's menu item that is supposed to restore the PSmiles graph's node shape to
     * its default value.
     * 
     ...
     * node color for the PSmiles graph via a JColorChooser.
     * 
    ...
    /**
     * Returns the menu bar's menu item that is supposed to restore the PSmiles graph's node color to
     * its default value.
     * 
    ...
    /**
     * Returns the menu bar's menu item that is supposed to restore the PSmiles graph's settings 
     ...
     * PSmiles graph as an image file by using a 'ui.screenshot' graph attribute.
     * 
     * @return the menu item that should export the PSmiles graph as an image file by graph attribute
     */
    ...
    /**
     * Returns the menu bar's menu item that is supposed to export the 
     * PSmiles graph as an image file by using GraphStream's 
     * {@link org.graphstream.stream.file.FileSinkImages} class.
     * 
     * @return the menu item that should export the PSmiles graph as an image file by 
    ...
    /**
     * Returns the menu bar's menu item that is supposed to export the 
     * PSmiles graph as an image file using Swing.
     * 
     * @return the menu item that should export the PSmiles graph as an image file using Swing
     */
     ...
     * whether the particle names should be written out in full on the PSmiles graph's nodes.
     * 
